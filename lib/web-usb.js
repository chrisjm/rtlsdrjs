...
USB.prototype.claimInterface = async function(i) {
  await this._device.claimInterface(i);
};

USB.prototype.releaseInterface = async function(i) {
  await this._device.releaseInterface(i);
};
